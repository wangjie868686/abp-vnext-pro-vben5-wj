 ...
 * 分页查询书籍
 */
export const postBooksPage = <ThrowOnError extends boolean = false>(options?: Options<PostBooksPageData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostBooksPageResponse, PostBooksPageError, ThrowOnError>({
        ...options,
        url: '/Books/Page'
    });
};
 ...
 * 创建书籍
 */
export const postBooksCreate = <ThrowOnError extends boolean = false>(options?: Options<PostBooksCreateData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostBooksCreateResponse, PostBooksCreateError, ThrowOnError>({
        ...options,
        url: '/Books/Create'
    });
};
 ...
 * 编辑书籍
 */
export const postBooksUpdate = <ThrowOnError extends boolean = false>(options?: Options<PostBooksUpdateData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostBooksUpdateResponse, PostBooksUpdateError, ThrowOnError>({
        ...options,
        url: '/Books/Update'
    });
};
 ...
 * 删除书籍
 */
export const postBooksDelete = <ThrowOnError extends boolean = false>(options?: Options<PostBooksDeleteData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostBooksDeleteResponse, PostBooksDeleteError, ThrowOnError>({
        ...options,
        url: '/Books/Delete'
    });
};
